...
var Storage = /** @class */ (function () {
    ...
    Storage.prototype.removeManyById = function (ids) {
        var _this = this;
        if (this.storageAdapter.removeManyById) {
            return queue.add(function () { return _this.storageAdapter.removeManyById(_this.dbName, _this.collectionName, ids); });
        }
        return Promise.all(ids.map(function (id) { return _this.removeById(id); }))
            .then(function (results) { return sum_1.default(results); });
    };
