                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (isArray_1.default(docs) && docs.length > batchSize) {
                            i_1 = 0;
                            batchCreate_1 = function (previousResult) {
                                if (previousResult === void 0) { previousResult = { entities: [], errors: [] }; }
                                return __awaiter(_this, void 0, void 0, function () {
                                    var batch, result, combinedResult;
    ...
    NetworkStore.prototype.save = function (doc, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (doc._id) {
                    kmd = new kmd_1.Kmd(cloneDeep_1.default(doc));
                    if (!kmd.isLocal()) {
