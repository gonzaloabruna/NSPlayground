...
var InvalidDeltaSetQueryError = /** @class */ (function (_super) {
    __extends(InvalidDeltaSetQueryError, _super);
...
var CacheStore = /** @class */ (function () {
    ...
    CacheStore.prototype._checkForDuplicateId = function (docs, cache) {
            ...
            return __generator(this, function (_a) {
                ...
                if (docs.length > 1) {
                    ...
                    docs.forEach(function (doc) {
                        if (doc._id) {
                            if (ids_1.has(doc._id)) {
                                throw new kinvey_1.KinveyError("The array contains more than one entity with _id '" + doc._id + "'.");
                            }
                            ids_1.add(doc._id);
                        }
                    });
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, cache.findById(doc._id)];
                                case 1:
                                    _a = (_b.sent()) != null;
                                    _b.label = 2;
                                case 2:
                                    if (_a) {
                                        throw new kinvey_1.KinveyError("An entity with _id '" + doc._id + "' already exists.");
                                    }
                                    return [2 /*return*/];
                            }
                        });
    ...
    CacheStore.prototype._createOne = function (doc, options) {
        if (options === void 0) { options = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var autoSync, cache, cachedDoc, sync, syncDoc, query, pushResults, pushResult;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (isArray_1.default(doc)) {
                            throw new kinvey_1.KinveyError('Unable to create an array of entities. Use "create" method to insert multiple entities.');
                        }
                        autoSync = options.autoSync === true || this.autoSync;
                        cache = new cache_1.DataStoreCache(this.collectionName, this.tag);
                        return [4 /*yield*/, this._checkForDuplicateId([doc], cache)];
                    case 1:
                        _a.sent();
                    ...
                    case 5: return [2 /*return*/, cachedDoc];
                }
            });
        });
    };
    CacheStore.prototype._createMany = function (docs, options) {
        if (options === void 0) { options = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var apiVersion, createManyResult, autoSync, cache, sync, cachedDocs, syncDocs, query;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        apiVersion = kinvey_2.getApiVersion();
                        if (apiVersion < 5) {
                            throw new kinvey_1.KinveyError('Unable to create an array of entities. Please create entities one by one or use API version 5 or newer.');
                        }
                        if (docs.length === 0) {
                            throw new kinvey_1.KinveyError('Unable to create an array of entities. The array must not be empty.');
                        }
                        createManyResult = {
                        ...
                        autoSync = options.autoSync === true || this.autoSync;
                        cache = new cache_1.DataStoreCache(this.collectionName, this.tag);
                        return [4 /*yield*/, this._checkForDuplicateId(docs, cache)];
                    case 1:
                        _a.sent();
                        sync = new sync_1.Sync(this.collectionName, this.tag);
                    ...
                    case 2:
                        cachedDocs = _a.sent();
                        return [4 /*yield*/, sync.addCreateSyncEvent(cachedDocs)];
                    case 3:
                        syncDocs = _a.sent();
                        if (!autoSync) return [3 /*break*/, 5];
                        query = new query_1.Query().contains('_id', syncDocs.map(function (doc) { return doc._id; }));
                        return [4 /*yield*/, sync.push(query, options)];
                    case 4:
                        syncDocs = _a.sent();
                        _a.label = 5;
                    case 5:
                        syncDocs.map(function (syncDoc, index) {
                            if (syncDoc.error) {
                        ...
                        return [2 /*return*/, createManyResult];
                }
            });
        });
    };
    CacheStore.prototype.create = function (docs, options) {
        if (options === void 0) { options = {}; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (!isArray_1.default(docs)) {
                    return [2 /*return*/, this._createOne(docs, options)];
                }
                return [2 /*return*/, this._createMany(docs, options)];
            });
        });
    };
    ...
    CacheStore.prototype.save = function (doc, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                apiVersion = kinvey_2.getApiVersion();
                if (apiVersion >= 5 && isArray_1.default(doc)) {
                    throw new kinvey_1.KinveyError('Unable to save an array of entities. Use "create" method to insert multiple entities.');
                }
                if (doc._id) {
                    return [2 /*return*/, this.update(doc, options)];
                }
                return [2 /*return*/, this.create(doc, options)];
            });
        });
    };
