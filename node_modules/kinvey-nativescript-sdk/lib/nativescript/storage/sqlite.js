...
function removeManyById(dbName, tableName, ids) {
    return __awaiter(this, void 0, void 0, function () {
        var responses, currentIds, deleteQuery, _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    deleteQuery = "DELETE FROM #{table} WHERE key IN (" + currentIds.map(function () { return '?'; }).join(', ') + ")";
                    _b = (_a = responses).push;
                    return [4 /*yield*/, execute(dbName, tableName, [[deleteQuery, currentIds]], true)];
                case 2:
                    _b.apply(_a, [_c.sent()]);
                    return [3 /*break*/, 1];
                case 3: return [2 /*return*/, sum_1.default(responses.map(function (r) { return r.shift(); }))];
            }
        });
    });
}
exports.removeManyById = removeManyById;
